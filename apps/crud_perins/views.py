...
from apps.crud_perins.models import inscripcion, periodo, alumnos, estado, carrera, localidad, grupo, municipio, puesto, rol, organigrama, \
    usuario, instructor, area, actividad, coordinador
from apps.crud_perins.forms import periodosForm, inscripcionForm, alumnosForm, estadoForm, usuarioForm, areaForm, organigramaForm, puestoForm, grupoForm, municipioForm, actividadForm, rolForm, carreraForm, localidadForm
from apps.crud_perins.filters import periodoFilter, inscripFilter, alumnosFilter, estadoFilter, usuarioFilter, areaFilter, organigramaFilter, puestoFilter, grupoFilter, municipioFilter, actividadFilter, rolFilter, carreraFilter, localidadFilter
